...
class PackageController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            foreach ($items as $key => $item) {
                $nestedData['id'] = $key + 1;
                $nestedData['package'] = (string)View::make('admin.m2.package.package-template', ['package' => $item])->render();
                $nestedData['options'] = (string)View::make('admin.m2.package.options-template', ['package' => $item])->render();;
            ...
            return View('admin.m2.package.index');
        }
    }
    ...
    {
        return View('admin.m2.package.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.m2.package.index')->with('status', 'Package added successfully!');
    }
    ...
    {
        return View('admin.m2.package.edit', compact('package'));
    }
    ...
    public function update(Request $request, Package $package)
    {
        ...
        return redirect()->route('admin.m2.packages.index')->with('status', 'Package updated successfully!');
    }
