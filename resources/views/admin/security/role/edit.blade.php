                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary card-outline">
                            <!-- form start -->
                            <form method="POST" action="{{ route('admin.security.roles.update', [$role]) }}" role="form" autocomplete="off" enctype="multipart/form-data" id="form" class="needs-validation">
                                @csrf
                                @method('PUT')
                                                        ...
                                                        <div class="form-group">
                                                            <div class="icheck-primary">
                                                                <input type="checkbox" name="permissions[]" value="{{ $permission->name }}"
                                                                       id="checkboxPrimary{{ $loop->index }}" {!! ($role_permissions->contains($permission->name)) ? 'checked' : null !!}>
