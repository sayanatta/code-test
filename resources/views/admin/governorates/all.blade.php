...
{{--                        @component('admin.components.datatable.actions')@endcomponent--}}
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('admin.governorates.create') }}" class="btn btn-sm bg-gradient-primary float-right"><i class="fas fa-plus"></i>&nbsp; Add New</a>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-12">
                                        <table class="table" id="table" style="margin: 0 !important;">
                                            ...
                                            @foreach($governorates as $governorate)
                                                ...
                                                <tr>
                                                    <td>{{$i}}</td>
                                                    <td>{{$governorate->title}}</td>
                                                    <td>{{$governorate->status}}</td>
                                                    <td>
                                                        <a href="{{route('admin.governorates.edit',$governorate->id)}}" class="btn btn-primary">Edit</a>&emsp;
