                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary card-outline">
                            <form id="remove-image-form" action="{{ route('admin.m1.packages.image.delete', [$package]) }}" method="POST" style="display: none;">
                                @csrf
                                @method('delete')
                            </form>

                            <!-- form start -->
                            <form method="POST" action="{{ route('admin.m1.packages.update', [$package]) }}" role="form" autocomplete="off" enctype="multipart/form-data" id="form" class="needs-validation">
                                @csrf
