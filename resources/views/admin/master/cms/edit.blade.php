                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary card-outline">
                            <!-- form start -->
                            <form method="POST" action="{{ route('admin.cms.update', [$masterCms]) }}" role="form" id="form" class="needs-validation">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group mb-0">
                                                <label>Content</label>
                                                <textarea name="content" class="form-control @error('content') is-invalid @enderror" id="editor">{{ $masterCms->content }}</textarea>
